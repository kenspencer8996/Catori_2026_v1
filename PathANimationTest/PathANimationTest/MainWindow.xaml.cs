...
namespace PathANimationTest
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void AnimateThis()
        {
            ...
            TestAnimatedUC testUC = new TestAnimatedUC();
            ...
            testUC.RenderTransform = animatedTranslateTransform;    
            ...
            //};
            testUC.Loaded += delegate (object sender, RoutedEventArgs e)
            {
                // Start the storyboard.
                pathAnimationStoryboard.Begin(this);
            };
