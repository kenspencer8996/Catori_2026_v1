    ...
    public class ManufacturingDatabaseInitializer
    {
        ...
        public async Task InitializeTablesAsync()
        {
            ...
            string scriptPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, 
                "Database", "Scripts", "CreateManufacturingTables.sql");
        ...
        public async Task InsertSampleDataAsync()
        {
            ...
            var finishedProduct = new CatoriServices.Objects.Entities.ProductEntity
            {
                ProductName = "Finished Widget",
                ProductCode = "FW-001",
                ProductType = CatoriServices.Objects.Entities.ProductType.Finished,
                UnitOfMeasure = "pcs",
                CostPerUnit = 25.00m,
            ...
            var componentA = new CatoriServices.Objects.Entities.ProductEntity
            {
                ProductName = "Component A",
                ProductCode = "CA-001",
                ProductType = CatoriServices.Objects.Entities.ProductType.Component,
                UnitOfMeasure = "pcs",
                CostPerUnit = 5.00m,
                CreatedAt = DateTime.Now
            };
            ...
            var componentB = new CatoriServices.Objects.Entities.ProductEntity
            {
            ...
            // Create BOM entries
            await bomRepo.InsertAsync(new CatoriServices.Objects.Entities.BillOfMaterialsEntity
            {
            ...
            await inventoryRepo.InsertAsync(new CatoriServices.Objects.Entities.InventoryEntity
            {
