...
namespace CatoriServices.Examples
{
    /// <summary>
    ...
    public class ManufacturingDatabaseExample
    {
        ...
        public async Task RunExampleAsync()
        {
            ...
            var inventoryRepo = new FactoryInventoryRepository();
            ...
            Console.WriteLine($"✓ Created finished product: {widget.ProductName} (ID: {widgetId})");
            ...
            Console.WriteLine($"✓ Created component: {frameComponent.ProductName} (ID: {frameId})");
            ...
            Console.WriteLine($"✓ Created component: {motorComponent.ProductName} (ID: {motorId})\n");
            ...
            Console.WriteLine($"✓ Added BOM: Widget needs 1x Frame (2% scrap)");
            ...
            Console.WriteLine($"✓ Added BOM: Widget needs 2x Motor (5% scrap)\n");
            ...
            Console.WriteLine($"✓ Added inventory: 50 Widgets at Main Warehouse");
            ...
            Console.WriteLine($"✓ Added inventory: 200 Frames at Main Warehouse");
            ...
            Console.WriteLine($"✓ Added inventory: 500 Motors at Main Warehouse\n");
            ...
            Console.WriteLine($"\n✓ Components needed for {widget.ProductName}:");
            ...
            Console.WriteLine($"\n✓ Material requirements to build 100 widgets:");
            foreach (var comp in components)
            {
                var compProduct = await productRepo.GetByIdAsync(comp.ComponentId);
                ...
                string availability = currentStock >= totalQty ? "✓ Available" : "✗ Insufficient";
            ...
            Console.WriteLine($"\n✓ Cost breakdown for {widget.ProductName}:");
            decimal totalCost = 0;
            foreach (var comp in components)
            {
                var compProduct = await productRepo.GetByIdAsync(comp.ComponentId);
                if (compProduct != null)
                {
                    ...
                    Console.WriteLine($"  - {compProduct.ProductName}: " +
                                    $"${compProduct.CostPerUnit} × {comp.Quantity} " +
