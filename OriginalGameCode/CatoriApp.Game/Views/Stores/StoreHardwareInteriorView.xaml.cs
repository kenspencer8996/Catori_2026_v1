...
namespace CatoriApp.Game.Views.Stores
{
    ...
    public partial class StoreHardwareInteriorView : Window, IStoreHardwareInteriorHost
    {
        ...
        void IStoreHardwareInteriorHost.ShopItemMouseDown(object? sender, ShopItemControlDrag e)
        {
            ShopItemMouseDown(sender, e);
        }

        void IStoreHardwareInteriorHost.ShopItemMouseUp(object? sender, ShopItemControlDrag e)
        {
            ShopItemMouseUp(sender, e);
        }
    }
}
