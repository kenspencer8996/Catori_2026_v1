...
namespace CatoriApp.Game.Controllers.Banking
{
    public class BankDepositsController
    {
        ...
        private readonly Views.Controls.Banking.BankDepositsView _view;
        ...
        public BankDepositsController(Views.Controls.Banking.BankDepositsView view, BankViewModel bankViewModel)
        {
