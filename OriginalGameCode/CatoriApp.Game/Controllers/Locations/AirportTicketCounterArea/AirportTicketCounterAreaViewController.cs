...
using CatoriApp.Game.Views.Locations.AirportTicketCounterArea;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.AirportTicketCounterArea;

public sealed class AirportTicketCounterAreaViewController : ControllerAnimateLayoutsBase
{
    private readonly AirportTicketCounterAreaView _view;
    public AirportTicketCounterAreaViewController(AirportTicketCounterAreaView view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("AirportTicketCounterArea").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'AirportTicketCounterArea' was not found in the game database.");
    ...
    {
        string configured="C:\\Development\\Gaming\\Catori2026\\Catori_2026_v1\\Images\\Airports\\AirportTicketCounterArea.png";
