...
using CatoriApp.Game.Views.Locations.toreGrocery1;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.toreGrocery1;

public sealed class toreGrocery1ViewController : ControllerAnimateLayoutsBase
{
    private readonly toreGrocery1View _view;
    public toreGrocery1ViewController(toreGrocery1View view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("toreGrocery1").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'toreGrocery1' was not found in the game database.");
    ...
    {
        string configured="C:\\Development\\Gaming\\Catori2026\\Catori_2026_v1\\Images\\LocationInteriors\\Store\\storeGrocery1.png";
