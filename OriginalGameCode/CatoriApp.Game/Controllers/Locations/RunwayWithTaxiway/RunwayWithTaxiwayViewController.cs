...
namespace CatoriApp.Game.Controllers.Locations.RunwayWithTaxiway;

public sealed class RunwayWithTaxiwayViewController : ControllerAnimateLayoutsBase
{
    private readonly RunwayWithTaxiwayView _view;
    public RunwayWithTaxiwayViewController(RunwayWithTaxiwayView view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("RunwayWithTaxiway").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'RunwayWithTaxiway' was not found in the game database.");
        _locationId=location.LocationId;
        LoadBackground();
        _view.LocationUCPanel.Content = 
                new CatoriApp.Game.Views.Controls.Locations.Factory.Location_UC(
        (int)_locationId);
    ...
    {
        string configured="C:\\Development\\Gaming\\Catori2026\\Catori_2026_v1\\Images\\Airports\\RunwayTaxiway.png";
