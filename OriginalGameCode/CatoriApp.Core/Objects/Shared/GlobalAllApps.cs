...
namespace CatoriApp.Core.Objects.Shared
{
    ...
    public class GlobalAllApps
    {
        ...
        public static PersonUC GetPerson(PersonMetadata metadata)
        {
            ...
            {
                PersonAvatarSettings avatarSettings = PersonAvatarSettings.FromJson(metadata.AvatarSettingsJson);
                avatarSettings.PersonRole = metadata.Role.ToString();
                person.ApplySettings(avatarSettings);
            }
            return person;
        }
