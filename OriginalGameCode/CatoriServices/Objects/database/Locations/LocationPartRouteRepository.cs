...
namespace CatoriServices.Objects.database.Locations
{
    public class LocationPartRouteRepository
    {
        ...
        {
            return Task.FromResult(new List<LocationPartRoutePointEntity>());
        }
