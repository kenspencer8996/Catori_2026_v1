...
namespace CatoriServices.Objects.database.Locations
{
    public class LocationRepository
    {
        ...
        {
            return await GetActiveLayoutByLocationIdAsync(LocationId);
        }
        ...
        {
            return GetFirstExistingColumnAsync(conn, "Location", "LocationId", "FactoryId");
        }

        private static Task<string> GetLocationNameColumnAsync(SqliteConnection conn)
        {
            return GetFirstExistingColumnAsync(conn, "Location", "LocationName", "FactoryName");
        }
