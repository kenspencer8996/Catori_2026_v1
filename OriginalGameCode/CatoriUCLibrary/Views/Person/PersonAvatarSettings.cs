...
public sealed class PersonAvatarSettings
{
    ...
    public string PersonRole { get; set; } = "Avatar";
    public static PersonAvatarSettings CreateDefault()
    {
        return new()
        {
    ...
    {
        return JsonSerializer.Deserialize<PersonAvatarSettings>(json, JsonOptions)
