...
namespace CatoriApp.Core.Objects.Shared
{
    public class CityScapeGlobal
    {
        ...
        public static void WriteDebugOutput(string message, [System.Runtime.CompilerServices.CallerMemberName] string memberName = "")
        {
        ...
        public static string CurrentHouseName { get; set; }
