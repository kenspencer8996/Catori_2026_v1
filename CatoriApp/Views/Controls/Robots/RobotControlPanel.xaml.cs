    ...
    public partial class RobotControlPanel : UserControl
    {
        ...
        private void RobotDesignButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MachineLayoutDesignerWindow view = 
                    new MachineLayoutDesignerWindow(LocationId, LocationBackgroundImagePath, sourcerectangle, Objects.Enums.MachineDesignerModeEnum.RobotArm);
