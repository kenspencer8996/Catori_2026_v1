...
namespace CatoriApp.Game.Views.Controls.City.Landscape
{
    /// <summary>
    ...
    public partial class LandscapeObjectControl : UserControl,IDropTarget
    {
        ...
        public LocationXYEntity Location { get; set; }

        public void AddImage(string imagename, int imageWidth, int imageHeight)
        {
