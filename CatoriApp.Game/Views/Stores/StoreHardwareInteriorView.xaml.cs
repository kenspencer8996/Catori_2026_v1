...
namespace CatoriApp.Game.Views.Stores
{
    /// <summary>
    /// Interaction logic for StoreHardwareView.xaml
    /// </summary>
    public partial class StoreHardwareInteriorView : Window, IStoreHardwareInteriorHost
    {
        ...
        Canvas IStoreHardwareInteriorHost.MainLayoutHardwareStoreInterior => MainLayoutHardwareStoreInterior;
        POSUI_UC IStoreHardwareInteriorHost.POSUC => POSUC;
        PersonViewModel IStoreHardwareInteriorHost.Model => Model;
        DependencyObject IStoreHardwareInteriorHost.AnimationTarget => this;
        void IStoreHardwareInteriorHost.ShopItemMouseDown(object? sender, ShopItemControlDrag e) => ShopItemMouseDown(sender, e);
        void IStoreHardwareInteriorHost.ShopItemMouseUp(object? sender, ShopItemControlDrag e) => ShopItemMouseUp(sender, e);
    }
}
