...
using CatoriApp.Game.Views.Controls.House;
using System.Net.NetworkInformation;
using System.Windows.Input;
namespace CatoriApp.Game.Views.House
{
    /// <summary>
    ...
    public partial class DetailHouseInsideView : Window
    {
        ...
        private void EntryDoorToGarage_OnOpenDoor(object? sender, CatoriApp.Core.Objects.Arguments.DoorOpenEventArgs e)
        {
