...
namespace CatoriApp.Game.Controllers.House
{
    public class RealEstateInteriorViewController
    {
        ...
        HouseViewModel _selectedHouse;
            public RealEstateInteriorViewController(RealestateInteriorView view)
            {
                _view = view;
