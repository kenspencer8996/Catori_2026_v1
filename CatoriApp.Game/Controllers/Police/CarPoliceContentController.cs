using StreetsEnum = CatoriServices.Objects.Entities.City.StreetsEnum;
...
namespace CatoriApp.Game.Controllers.Police
{
    internal class CarPoliceContentController
    {
        private CarPoliceControl _view;
        ...
        internal CarPoliceContentController(CarPoliceControl view, double startingX, double startingY)
        {
