...
namespace CatoriApp.Game.Controllers.LocationSubControllers
{
        ...
        ILocationSubController
    {
        ...
        ProductUC part18_productUC;
        PathAnimationHandle _pathHandlerConveyor41;
        ProductUC part19_productUC;
        PathAnimationHandle _pathHandlerConveyor5;
        ProductUC part20_productUC;
        PathAnimationHandle _pathHandlerConveyor12;
        ProductUC part21_productUC;
        PathAnimationHandle _pathHandlerConveyor13;
        ProductUC part22_productUC;
        PathAnimationHandle _pathHandlerConveyor14;
        ...
        private void SetupAnimations()
        {
            ...
            part15_productUC = new ProductUC("");
            ...
            part17_productUC = new ProductUC("");
            ...
            part18_productUC = new ProductUC("");
            // Code for Layout Item: Conveyor41
            string path18 = "";
            _pathHandlerConveyor41 = GameAnimationHelper.AddControlOnPath("Conveyor41", _view.MainCanvas,
            part18_productUC, path18, options);

            part19_productUC = new ProductUC("");
            ...
            part20_productUC = new ProductUC("");
            // Code for Layout Item: Conveyor12
            string path20 = "";
            _pathHandlerConveyor12 = GameAnimationHelper.AddControlOnPath("Conveyor12", _view.MainCanvas,
            part20_productUC, path20, options);

            part21_productUC = new ProductUC("");
            ...
            part22_productUC = new ProductUC("");
            // Code for Layout Item: Conveyor14
            string path22 = "";
            _pathHandlerConveyor14 = GameAnimationHelper.AddControlOnPath("Conveyor14", _view.MainCanvas,
            part22_productUC, path22, options);
