...
using CatoriApp.Game.Views.Locations.Factory1;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.Factory1;

public sealed class Factory1ViewController : ControllerAnimateLayoutsBase
{
    private readonly Factory1View _view;
    public Factory1ViewController(Factory1View view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("Factory1").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'Factory1' was not found in the game database.");
    ...
    {
        string configured="C:\\\\Development\\\\Gaming\\\\Catori2026\\\\Catori_2026_v1\\\\Images\\\\LocationInteriors\\\\Factory\\\\LocationInterior1.png";
