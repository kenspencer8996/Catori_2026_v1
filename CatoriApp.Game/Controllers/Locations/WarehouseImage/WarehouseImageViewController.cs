...
using CatoriApp.Game.Views.Locations.WarehouseImage;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.WarehouseImage;

public sealed class WarehouseImageViewController : ControllerAnimateLayoutsBase
{
    private readonly WarehouseImageView _view;
    public WarehouseImageViewController(WarehouseImageView view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("WarehouseImage").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'WarehouseImage' was not found in the game database.");
    ...
    {
        string configured="C:\\Development\\Gaming\\Catori2026\\Catori_2026_v1\\Images\\Warehouses\\WarehouseInterior.png";
