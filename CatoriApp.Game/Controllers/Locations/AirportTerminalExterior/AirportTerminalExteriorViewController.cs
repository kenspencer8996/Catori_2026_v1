...
using CatoriApp.Game.Views.Locations.AirportTerminalExterior;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.AirportTerminalExterior;

public sealed class AirportTerminalExteriorViewController : ControllerAnimateLayoutsBase
{
    private readonly AirportTerminalExteriorView _view;
    public AirportTerminalExteriorViewController(AirportTerminalExteriorView view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("AirportTerminalExterior").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'AirportTerminalExterior' was not found in the game database.");
    ...
    {
        string configured="C:\\Development\\Gaming\\Catori2026\\Catori_2026_v1\\Images\\Airports\\AirportTerminal.png";
