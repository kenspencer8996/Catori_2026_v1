...
using CatoriApp.Game.Views.Locations.factory2;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.factory2;

public sealed class factory2ViewController : ControllerAnimateLayoutsBase
{
    private readonly factory2View _view;
    public factory2ViewController(factory2View view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("factory2").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'factory2' was not found in the game database.");
    ...
    {
        string configured="C:\\\\Development\\\\Gaming\\\\Catori2026\\\\Catori_2026_v1\\\\Images\\\\LocationInteriors\\\\Factory\\\\Locationinterior2.png";
