...
using CatoriApp.Game.Views.Locations.BeachFlyover;
using System.IO;
using System.Windows.Input;

namespace CatoriApp.Game.Controllers.Locations.BeachFlyover;

public sealed class BeachFlyoverViewController : ControllerAnimateLayoutsBase
{
    private readonly BeachFlyoverView _view;
    public BeachFlyoverViewController(BeachFlyoverView view)
    {
        _view=view??throw new ArgumentNullException(nameof(view));
        var location=new CatoriServices.Objects.database.Locations.LocationRepository().GetByNameAsync("BeachFlyover").GetAwaiter().GetResult()
            ??throw new InvalidOperationException("Location 'BeachFlyover' was not found in the game database.");
    ...
    {
        string configured="C:\\Development\\Gaming\\Catori2026\\Catori_2026_v1\\Images\\Airports\\BeachTravel.png";
