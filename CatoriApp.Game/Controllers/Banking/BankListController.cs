using CatoriApp.Game.Objects.Services;
using System;
...
namespace CatoriApp.Game.Controllers.Banking
{
    public class BankListController
    {
        ...
        private readonly Views.Controls.Banking.BankListView _view;

        public ObservableCollection<BankViewModel> Banks { get; } = new ObservableCollection<BankViewModel>();

        public BankListController(Views.Controls.Banking.BankListView view)
        {
        ...
        {
            if (vm == null) return;
            var editView = new Views.Controls.Banking.BankEditView(vm);
