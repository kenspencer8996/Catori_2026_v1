...
namespace CatoriApp.Game.Controllers.Stores
{
    public interface IStoreHardwareInteriorHost
    {
        Canvas MainLayoutHardwareStoreInterior { get; }
        POSUI_UC POSUC { get; }
        PersonViewModel Model { get; }
        DependencyObject AnimationTarget { get; }
        System.Windows.Threading.Dispatcher Dispatcher { get; }
        void ShopItemMouseDown(object? sender, ShopItemControlDrag e);
        void ShopItemMouseUp(object? sender, ShopItemControlDrag e);
    }

    public class StoreHardwareInteriorViewController : StoreInteriorControllerBase
    {
        IStoreHardwareInteriorHost _view;
        int boxheight = 100;
        ...
        public StoreHardwareInteriorViewController(
            IStoreHardwareInteriorHost view)
        {
            _view = view;
            LoadControls();
            LoadShelves();
        ...
        internal void MoveUpBox()
        {
            ...
            Storyboard.SetTarget(daleft, _view.AnimationTarget);
